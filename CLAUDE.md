...
| 周次 | 主题 | 核心产出 |
|------|------|---------|
| W1 | 认证体系 | 企业注册/登录 + 零工微信登录 + JWT |
| W2 | 任务发布 | 5步向导 + 角色配置 + 状态机 |
| W3 | 撮合+资金 | 定向分配 + 充值 + 108%锁定 |
| W4 | 执行+IM | 交付物 + WebSocket + 合同 |
| W5 | 结算+通知 | 合规通道 + 提现 + 订阅消息 |
| W6 | 联调+安全 | 全端联调 + E2E测试 + 安全加固 |
| W7-W9 | Sprint2功能 | 人天/评价/仲裁/推荐/Dashboard |
| W10-W11 | 质量保障 | 压测 + OWASP + 回归 |
| W12 | 灰度上线 | 监控 + 分批放量 |
